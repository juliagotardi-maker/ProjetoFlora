  ...
  return (
    <div className="pagina-presentes">
      ...
      <div className="grid-produtos">
        ...
        <Carrinho imagem={presente5} nome="Cesta Romântica" preco={149.90} />
        <Carrinho imagem={presente6} nome="Box Chocolate" preco={119.90} />
        <Carrinho imagem={presente7} nome="Cesta Premium" preco={229.90} />
        <Carrinho imagem={presente8} nome="Kit Surpresa" preco={189.90} />
      </div>
